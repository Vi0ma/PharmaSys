        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleLabel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Form = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
                    Dosage = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SaleItems_Medications_MedicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleItems_MedicationId",
                table: "SaleItems",
                column: "MedicationId");
